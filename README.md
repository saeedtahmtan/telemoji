...
Visit our [GitHub Pages site](https://saeedtahmtan.github.io/telemoji/) to browse all emojis, search for specific ones, and get integration code.

### WebP Format (Recommended for most websites)

```html
<img src="https://saeedtahmtan.github.io/telemoji/webp/animated/U+1F600.webp"
     alt="Grinning Face"
     style="width: 120px;">
```
...
<tgs-player src="https://saeedtahmtan.github.io/telemoji/tgs/animated/U+1F600.tgs"
            autoplay loop
...
```markdown
![Grinning Face](https://saeedtahmtan.github.io/telemoji/webp/animated/U+1F600.webp)
```
...
- Create language/region selectors with animated flags
- Add flair to social features and notifications
- Use as animated icons in web and mobile apps
